...
// data input
wire          axi_d_awready_i;
wire          axi_d_wready_i;
wire          axi_d_bvalid_i;
wire [  1:0]  axi_d_bresp_i;
wire [  3:0]  axi_d_bid_i;
wire          axi_d_arready_i;
wire          axi_d_rvalid_i;
wire [ 31:0]  axi_d_rdata_i;
wire [  1:0]  axi_d_rresp_i;
wire [  3:0]  axi_d_rid_i;
wire          axi_d_rlast_i;
...
(
    ...
    .s01_axi_awid(axi_d_awid_o),
    .s01_axi_awaddr(axi_d_awaddr_o),
    .s01_axi_awlen(axi_d_awlen_o),
    .s01_axi_awsize(3'b010),    //32 bits width
    .s01_axi_awburst(axi_d_awburst_o),
    .s01_axi_awlock(0),
    .s01_axi_awcache(0),
    .s01_axi_awprot(0),
    .s01_axi_awqos(0),
    .s01_axi_awuser(0),
    .s01_axi_awvalid(axi_d_awvalid_o),
    .s01_axi_awready(axi_d_awready_i),
    .s01_axi_wdata(axi_d_wdata_o),
    .s01_axi_wstrb(axi_d_wstrb_o),
    .s01_axi_wlast(axi_d_wlast_o),
    .s01_axi_wuser(0),
    .s01_axi_wvalid(axi_d_wvalid_o),
    .s01_axi_wready(axi_d_wready_i),
    .s01_axi_bid(axi_d_bid_i),
    .s01_axi_bresp(axi_d_bresp_i),
    .s01_axi_buser(),
    .s01_axi_bvalid(axi_d_bvalid_i),
    .s01_axi_bready(axi_d_bready_o),
    .s01_axi_arid(axi_d_arid_o),
    .s01_axi_araddr(axi_d_araddr_o),
    .s01_axi_arlen(axi_d_arlen_o),
    .s01_axi_arsize(3'b010),
    .s01_axi_arburst(axi_d_arburst_o),
    .s01_axi_arlock(0),
    .s01_axi_arcache(0),
    .s01_axi_arprot(0),
    .s01_axi_arqos(0),
    .s01_axi_aruser(0),
    .s01_axi_arvalid(axi_d_arvalid_o),
    .s01_axi_arready(axi_d_arready_i),
    .s01_axi_rid(axi_d_rid_i),
    .s01_axi_rdata(axi_d_rdata_i),
    .s01_axi_rresp(axi_d_rresp_i),
    .s01_axi_rlast(axi_d_rlast_i),
    .s01_axi_ruser(axi_d_ruser_o),
    .s01_axi_rvalid(axi_d_rvalid_i),
    .s01_axi_rready(axi_d_rready_o),
