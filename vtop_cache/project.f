...
#wrapper
#$(WRAPPER_DIR)/dcache_axi_axi.v
#$(WRAPPER_DIR)/dcache_core.v
#$(WRAPPER_DIR)/dcache.v
#$(WRAPPER_DIR)/riscv_top.v
#$(WRAPPER_DIR)/dcache_axi.v            
#$(WRAPPER_DIR)/dcache_if_pmem.v   
#$(WRAPPER_DIR)/icache_data_ram.v
#$(WRAPPER_DIR)/dcache_core_data_ram.v  
#$(WRAPPER_DIR)/dcache_mux.v       
#$(WRAPPER_DIR)/icache_tag_ram.v
#$(WRAPPER_DIR)/dcache_core_tag_ram.v   
#$(WRAPPER_DIR)/dcache_pmem_mux.v
#$(WRAPPER_DIR)/icache.v
